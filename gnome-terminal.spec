...
Source0  : https://download.gnome.org/sources/gnome-terminal/3.26/gnome-terminal-3.26.1.tar.xz
...
%prep
%setup -q -n gnome-terminal-3.26.1
...
export LANG=C
export SOURCE_DATE_EPOCH=1507037567
export AR=gcc-ar
