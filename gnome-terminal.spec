...
Version  : 3.44.0
Release  : 51
URL      : https://download.gnome.org/sources/gnome-terminal/3.44/gnome-terminal-3.44.0.tar.xz
Source0  : https://download.gnome.org/sources/gnome-terminal/3.44/gnome-terminal-3.44.0.tar.xz
...
%prep
%setup -q -n gnome-terminal-3.44.0
cd %{_builddir}/gnome-terminal-3.44.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1648497279
...
cp %{_builddir}/gnome-terminal-3.44.0/COPYING %{buildroot}/usr/share/package-licenses/gnome-terminal/842745cb706f8f2126506f544492f7a80dbe29b3
cp %{_builddir}/gnome-terminal-3.44.0/COPYING.GFDL %{buildroot}/usr/share/package-licenses/gnome-terminal/715f995f11805ee85601834220c43b082f457ea3
