...
Version  : 3.24.2
Release  : 7
URL      : https://download.gnome.org/sources/gnome-terminal/3.24/gnome-terminal-3.24.2.tar.xz
Source0  : https://download.gnome.org/sources/gnome-terminal/3.24/gnome-terminal-3.24.2.tar.xz
...
%prep
%setup -q -n gnome-terminal-3.24.2
...
export LANG=C
export SOURCE_DATE_EPOCH=1494582033
export AR=gcc-ar
