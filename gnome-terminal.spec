...
Version  : 3.30.2
Release  : 25
URL      : https://download.gnome.org/sources/gnome-terminal/3.30/gnome-terminal-3.30.2.tar.xz
Source0  : https://download.gnome.org/sources/gnome-terminal/3.30/gnome-terminal-3.30.2.tar.xz
...
%prep
%setup -q -n gnome-terminal-3.30.2
...
export LANG=C
export SOURCE_DATE_EPOCH=1540250054
export AR=gcc-ar
...
cp COPYING.GFDL %{buildroot}/usr/share/package-licenses/gnome-terminal/COPYING.GFDL
%make_install
...
%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/gnome-terminal/COPYING
/usr/share/package-licenses/gnome-terminal/COPYING.GFDL
