...
Version  : 3.56.1
Release  : 65
URL      : https://download.gnome.org/sources/gnome-terminal/3.56/gnome-terminal-3.56.1.tar.xz
Source0  : https://download.gnome.org/sources/gnome-terminal/3.56/gnome-terminal-3.56.1.tar.xz
...
%prep
%setup -q -n gnome-terminal-3.56.1
cd %{_builddir}/gnome-terminal-3.56.1
pushd ..
cp -a gnome-terminal-3.56.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744647014
