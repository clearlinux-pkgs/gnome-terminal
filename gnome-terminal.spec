...
Source0  : https://download.gnome.org/sources/gnome-terminal/3.40/gnome-terminal-3.40.3.tar.xz
...
%prep
%setup -q -n gnome-terminal-3.40.3
cd %{_builddir}/gnome-terminal-3.40.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1625846675
...
cp %{_builddir}/gnome-terminal-3.40.3/COPYING %{buildroot}/usr/share/package-licenses/gnome-terminal/842745cb706f8f2126506f544492f7a80dbe29b3
cp %{_builddir}/gnome-terminal-3.40.3/COPYING.GFDL %{buildroot}/usr/share/package-licenses/gnome-terminal/715f995f11805ee85601834220c43b082f457ea3
%make_install
