...
Source0  : https://download.gnome.org/sources/gnome-terminal/3.28/gnome-terminal-3.28.2.tar.xz
...
%prep
%setup -q -n gnome-terminal-3.28.2
...
export LANG=C
export SOURCE_DATE_EPOCH=1527278511
export AR=gcc-ar
