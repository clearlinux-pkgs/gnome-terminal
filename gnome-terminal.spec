...
Source0  : https://download.gnome.org/sources/gnome-terminal/3.30/gnome-terminal-3.30.1.tar.xz
...
Requires: gnome-terminal-config = %{version}-%{release}
...
%prep
%setup -q -n gnome-terminal-3.30.1
...
export LANG=C
export SOURCE_DATE_EPOCH=1537842413
export AR=gcc-ar
