...
Source0  : https://download.gnome.org/sources/gnome-terminal/3.30/gnome-terminal-3.30.0.tar.xz
...
Requires: gnome-terminal-license
...
%prep
%setup -q -n gnome-terminal-3.30.0
...
export LANG=C
export SOURCE_DATE_EPOCH=1535936701
export AR=gcc-ar
...
export SOURCE_DATE_EPOCH=1535936701
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/gnome-terminal
cp COPYING %{buildroot}/usr/share/doc/gnome-terminal/COPYING
cp COPYING.GFDL %{buildroot}/usr/share/doc/gnome-terminal/COPYING.GFDL
%make_install
...
/usr/share/help/C/gnome-terminal/txt-save-text.page
...
/usr/share/help/ca/gnome-terminal/txt-save-text.page
...
/usr/share/help/cs/gnome-terminal/txt-save-text.page
...
/usr/share/help/de/gnome-terminal/txt-save-text.page
...
/usr/share/help/el/gnome-terminal/txt-save-text.page
...
/usr/share/help/es/gnome-terminal/txt-save-text.page
...
/usr/share/help/fi/gnome-terminal/txt-save-text.page
...
/usr/share/help/fr/gnome-terminal/txt-save-text.page
...
/usr/share/help/gl/gnome-terminal/txt-save-text.page
...
/usr/share/help/hu/gnome-terminal/txt-save-text.page
...
/usr/share/help/ko/gnome-terminal/txt-save-text.page
...
/usr/share/help/pl/gnome-terminal/pref-encoding.page
...
/usr/share/help/pl/gnome-terminal/txt-save-text.page
...
/usr/share/help/pt_BR/gnome-terminal/txt-save-text.page
...
/usr/share/help/ro/gnome-terminal/pref-encoding.page
...
/usr/share/help/ro/gnome-terminal/txt-save-text.page
...
/usr/share/help/ru/gnome-terminal/txt-save-text.page
...
/usr/share/help/sv/gnome-terminal/txt-save-text.page
...
%files license
%defattr(-,root,root,-)
/usr/share/doc/gnome-terminal/COPYING
/usr/share/doc/gnome-terminal/COPYING.GFDL
