...
Source0  : https://download.gnome.org/sources/gnome-terminal/3.32/gnome-terminal-3.32.2.tar.xz
...
%prep
%setup -q -n gnome-terminal-3.32.2
...
export LANG=C
export SOURCE_DATE_EPOCH=1557183162
export AR=gcc-ar
